...
<body>
	<div id="container">
		...
		<div id="content">
			<div id="board">
				<form id="search_form"
					action="${pageContext.request.contextPath }/bookmark" method="post">
					...
					<c:forEach items="${list}" begin="0" step="1" varStatus="status"
						...
						<tr class="board">
							...
							<td style="text-align: left; padding-left: 0px;"><a
								...
								href="${pageContext.request.contextPath }/bookmark/view?no=${vo.no}&keyword=${keyword}" onclick="setHistory(this)">
							...
							<a
									href="${pageContext.request.contextPath }/bookmark/delete?no=${vo.no}&keyword=${keyword}"
									class="del">삭제</a>
							</c:if>
							</td>
						</tr>
				...
				<div class="bottom">
					<c:if test="${!empty authUser }">
						<a href='${pageContext.request.contextPath }/bookmark/write'
							id="new-book">글쓰기</a>
					</c:if>
				</div>
<!-- 
